public enum ArtikolBloko: Codable {
	...
	public func encode(to encoder: any Encoder) throws {
		...
		case .dividila(teksto: let teksto):
			var nestedContainer = container.nestedContainer(keyedBy: ArtikolBloko.DividilaCodingKeys.self, forKey: .dividila)
			try nestedContainer.encode(teksto, forKey: ArtikolBloko.DividilaCodingKeys.teksto)
		case .derivajhTitola(let teksto, let ofc, let marko):
